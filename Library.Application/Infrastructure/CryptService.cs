...
{
    public string GenerateHash(string key, string data) => GenerateHash(Encoding.UTF8.GetBytes(key), data);
    public string GenerateHash(byte[] key, string data) => GenerateHash(key, Encoding.UTF8.GetBytes(data));
